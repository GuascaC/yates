...
<main>
    ...
    <div class="card text-start">
        <div class="card-body">
            ...
            ?>
            <form action="../../../php/admin/edit/brand.php" method="post">
                <div class="card text-start">
                    <div class="card-body">
                        <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
                        <h4 class="card-title"><?php echo "Marca: ".$result['brand'] ?></h4>
                        <input class="card-text" type="text" placeholder="Marca" autofocus autocomplete="on" name="brand" value="<?php echo $result['brand'] ?>"> 
                        <a href="../brand.php" class="btn btn-light text-dark">Cancelar</a>
