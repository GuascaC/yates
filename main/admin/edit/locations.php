...
<main>
    ...
    <div class="card text-start">
        <div class="card-body">
    <?php
        $location = new location(0,0,0,$_POST['id']);
        $sql = $location->show2();
        $query= mysqli_query($cone ,$sql);
    ...
    ?>
        <form action="../../../php/admin/edit/locations.php" method="post">
        <div class="card text-start">
        <div class="card-body">
            ...
            <input class="card-text" type="text" placeholder="Dirección" autofocus autocomplete="on" name="address" value="<?php echo $result['address'] ?>"> 
            <p class="card-title">Horario: </p>
            <input class="card-text" type="text" placeholder="Horario" autofocus autocomplete="on" name="schedule" value="<?php echo $result['schedule'] ?>"> 
            <a href="../locations.php" class="btn btn-light text-dark">Cancelar</a>
