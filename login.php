...
<header class="d-flex w-100">
  ...
  <main>
    ...
    <section class="card container text-center">
      ...
      <br><br>
      <form action="./php/login.php" method="post" class="formInicio2">
        <div class="col-md-6">
            <div class="text-center">
              <label><i class="fa-solid fa-user"></i>Correo electrónico</label><br>
              <input class="" type="email" placeholder="Correo electrónico" autofocus autocomplete="on" required name="email">
            </div>
        </div>
        <div class="col-md-6">
          <div class="text-center">
          <label><i class="fa-solid fa-lock"></i>Contraseña</label><br>
            <input class="" maxlength="15"
              oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="iPass"
              type="password" placeholder="Contraseña" name="password" required>
            <img onclick="PassV()" src="./img/visible.png">
          </div>
        </div>
        <a class="link" href="./register.php">Registrate aquí</a><br><br>
