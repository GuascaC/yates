...
<header class="d-flex w-100">
  ...
  <main>
        <a href="./meeting.php"><button class="btn btn-secondary">Agendar cita</button></a>
    <section class="Catalog">
      ...
      ?>
      <form action="../../php/user/yatch.php" method="post">
      <div class="card text-start">
        <div class="card-body">
          ...
          <input type="submit" button class="btn btn-success text-light" value="Comprar">
          </form>
        </div>
      </div>
      <br>
...
<div class="card text-start">
      ...
      ?>
      <form action="../../php/user/accesories.php" method="post">
      <div class="card text-start">
        <div class="card-body">
          <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
