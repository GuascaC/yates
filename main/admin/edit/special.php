...
<main>
    ...
    <div class="card text-start">
        <div class="card-body">
    <?php
            $special = new special(0,$_POST['id']);
            $sql = $special->show();
        $query= mysqli_query($cone ,$sql);
    ...
    ?>
        <form action="../../../php/admin/edit/special.php" method="post">
        <div class="card text-start">
        <div class="card-body">
            <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
            <h4 class="card-title"><?php echo "Especialidad: ".$result['special'] ?></h4>
            <input class="card-text" type="text" placeholder="Especialidad" autofocus autocomplete="on" name="special" value="<?php echo $result['special'] ?>"> 
            <a href="../special.php" class="btn btn-light text-dark">Cancelar</a>
    ...
    <?php
        ...
        echo '<p class="">No hay especialidades registradas</p>';
    }
    ?>
    </section>
  </main>
