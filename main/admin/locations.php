...
<main>
    ...
    ?>
        <form action="./edit/locations.php" method="post">
        <div class="card text-start">
        <div class="card-body">
            <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
            <h4 class="card-title"><?php echo "Nombre: ".$result['name'] ?></h4>
            <p class="card-text"><?php echo "Dirección: ".$result['address'] ?></p>
            <p class="card-text"><?php echo "Horario: ".$result['schedule'] ?></p>
            <input type="submit" button class="btn btn-primary text-light" value="Editar">
        </form>
        <form action="../../php/admin/delete/locations.php" method="post">
        <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
